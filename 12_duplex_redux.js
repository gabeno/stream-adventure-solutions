...
written (given?) objects with a 2-character `country` field as input, such as these:
...
module.exports = function(counter) {
  ...
  // with objects having some data to be aggregated
  var stats = {};

  // create a readable-writable stream
  var readwriteStream = through(write, end);

  function write(obj) {
    stats[obj.country] = (stats[obj.country] || 0) + 1;
  }

  function end() {
    counter.setCounts(stats);
  }

  // return dupex stream
  return duplexer(readwriteStream, counter);
}